...
namespace PlayerStates
{
    public class Swing : State<PlayerController>
    {
        ...
        public override void OnExit()
        {
            ...
            Vector3 v = ctx.jumpForce / 1.3f * Mathf.InverseLerp(90, 0, angle) * Time.fixedDeltaTime * Vector3.Up;
            ...
            v += ctx.jumpForce / 1.3f * Mathf.InverseLerp(90, 0, angle) * Time.fixedDeltaTime * ctx.Transform.Forward();
            ctx.Velocity = v;
            ctx.divesLeft = 1;
