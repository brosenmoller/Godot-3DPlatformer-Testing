...
namespace PlayerStates
{
    public class GrappleSwing : State<PlayerController>
    {
        ...
        {
            //ctx.Velocity += PlayerController.GRAVITY * (grappleGravityAdjustment - 1) * ctx.PhysicsDelta(); * Vector3.Up;
            //ctx.Velocity += ctx.swingSpeed * ctx.PhysicsDelta(); * ctx.InputDirection;
